...
final class NewsFeedCodeCell: UITableViewCell {
    ...
    // The Fourth layer on bottomViewViews
    ...
    private func overlayFourthLayerOnBottomViewViews() {
        ...
        helpInFourthLayer(view: likesView, imageView: likesImage, labelView: likesLabel)
        helpInFourthLayer(view: commentsView, imageView: commentsImage, labelView: commentsLabel)
        helpInFourthLayer(view: sharesView, imageView: sharesImage, labelView: sharesLabel)
        helpInFourthLayer(view: viewsView, imageView: viewsImage, labelView: viewsLabel)
    }
    
    private func helpInFourthLayer(view: UIView, imageView: UIImageView, labelView: UILabel) {
        ...
        labelView.leadingAnchor.constraint(equalTo: imageView.trailingAnchor, constant: 4).isActive = true
    ...
    private func overlayThirdLayerOnTopView() {
        ...
        dateLabel.bottomAnchor.constraint(equalTo: iconImageView.bottomAnchor, constant: -2).isActive = true
